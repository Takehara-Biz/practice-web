...
export class StoreApiController {
  ...
  deleteOrder(@Param('orderId') orderId: number, @Req() request: Request): void | Promise<void> | Observable<void> {
  ...
  @Post('/store/order')
  placeOrder(@Body() order: Order | undefined, @Req() request: Request): Order | Promise<Order> | Observable<Order> {
