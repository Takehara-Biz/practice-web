...
export abstract class PetApi {
  ...
  abstract findPetsByStatus(status: 'available' | 'pending' | 'sold' | undefined,  request: Request): Array<Pet> | Promise<Array<Pet>> | Observable<Array<Pet>>;


  abstract findPetsByTags(tags: Array<string> | undefined,  request: Request): Array<Pet> | Promise<Array<Pet>> | Observable<Array<Pet>>;
  ...
  abstract uploadFile(petId: number, additionalMetadata: string | undefined, body: Blob | undefined,  request: Request): ApiResponse | Promise<ApiResponse> | Observable<ApiResponse>;
